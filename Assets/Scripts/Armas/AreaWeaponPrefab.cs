...
public class AreaWeaponPrefab : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        AudioController.Instance.ReproducirSonido(AudioController.Instance.armaAreaSpawn);
    }
    ...
    void Update()
    {
        ...
        if (timer <= 0)
        {
            ...
            {
                Destroy(gameObject);
                AudioController.Instance.ReproducirSonido(AudioController.Instance.armaAreaDespawn);
            }
        }
