...
public class SpinWeaponPrefab : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        AudioController.Instance.ReproducirSonido(AudioController.Instance.armaGiratoriaSpawn);
    }
    ...
    void Update()
    {
        ...
        if (duration <= 0)
        {
            ...
            {
                AudioController.Instance.ReproducirSonido(AudioController.Instance.armaGiratoriaDespawn);
                Destroy(gameObject);
            }
        }
    }
